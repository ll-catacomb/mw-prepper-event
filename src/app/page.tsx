...
export default function Home() {
  return (
    <main className="relative w-full h-screen overflow-hidden bg-black select-none flex">
      ...
      {/* ── Right half: Clean code-style event info ── */}
      <div className="w-full lg:w-1/2 h-full relative flex flex-col justify-center px-10 sm:px-16 lg:px-20">
        ...
        <p className="absolute bottom-8 left-10 sm:left-16 lg:left-20 font-mono text-[10px] text-white/10 tracking-widest fade-in fade-in-delay-7">
