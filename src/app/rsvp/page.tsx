...
export default function RSVPPage() {
  ...
  return (
    <>
      {/* ── Desktop: dual MP4 background with centered form ── */}
      <main className="hidden lg:block relative w-full min-h-screen overflow-hidden bg-black">
      ...
      {/* ── Mobile: full-screen video first, scroll to form ── */}
      <main className="lg:hidden bg-black">
        ...
        {/* Form section */}
        <div className="relative w-full min-h-screen flex items-center justify-center px-6 py-16">
          {formContent}
        </div>
      </main>
    </>
